...
/* One mask for both tx and rx */
#define VIC_TIMER3_EN 0x80000
#define VIC_UART1_EN 0x100000
#define VIC_UART2_EN 0x400000

/* in khz */
#define TIMER3_CLK_RATE 508
