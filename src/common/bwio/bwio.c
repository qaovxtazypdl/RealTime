...
int bwsetspeed( int channel, int speed ) {
  int *high, *low, *high_reg;
  switch( channel ) {
  case COM1:
    high = (int *)( UART1_BASE + UART_LCRM_OFFSET );
    low = (int *)( UART1_BASE + UART_LCRL_OFFSET );
    high_reg = (int *)( UART1_BASE + UART_LCRH_OFFSET );
          break;
  case COM2:
    high = (int *)( UART2_BASE + UART_LCRM_OFFSET );
    low = (int *)( UART2_BASE + UART_LCRL_OFFSET );
    high_reg = (int *)( UART2_BASE + UART_LCRH_OFFSET );
          break;
  default:
          return -1;
          break;
  ...
  case 115200:
    *high = 0x0;
    *low = 0x3;
    *high_reg = *high_reg; /* Necessary to force changes to the mid/low registers to take effect */
    return 0;
  case 2400:
    *high = 0x0;
    *low = 0xBF;
